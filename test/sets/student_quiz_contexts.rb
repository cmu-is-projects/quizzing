module Contexts
  module StudentQuizContexts
    ...
    def create_senior_b_student_quizzes
      ...
      @nate3 = FactoryGirl.create(:student_quiz, student: @nate, quiz: @quiz3, num_correct: 1, num_attempts: 1, num_fouls: 3)
      ...
      @dean2 = FactoryGirl.create(:student_quiz, student: @dean, quiz: @quiz2, num_correct: 4, num_attempts: 5, num_fouls: 0)
      ...
      @dean6 = FactoryGirl.create(:student_quiz, student: @dean, quiz: @quiz6, num_correct: 0, num_attempts: 1, num_fouls: 0)
    end
